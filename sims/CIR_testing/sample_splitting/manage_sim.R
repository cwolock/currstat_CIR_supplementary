...
sim_name <- "CIR_testing_samplesplit_033025"
nreps_total <- 500
nreps_per_job <- 1

source("/home/cwolock/currstat_CIR_supplementary/sims/CIR_testing/sample_splitting/do_one.R")

ns <- c(500, 1000, 1500, 2000)
methods <- c("sample_split", "no_split")
